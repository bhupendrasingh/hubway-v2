...
export class AppComponent implements OnInit {
  ...
  markerAndStatus(stationList, stationStatusReports) {
    ...
    for (var _i = 0; _i < stationsArray.length; _i++) {
      var station_id = stationsArray[_i]['station_id'];
      ...
      marker.addListener('click', function () {
        this.createStatusWindow(station_id, marker, stationStatusReports);
        // var statusPair = allStationStatus.filter(function (station) {
        //   if (station['station_id'] == station_id) {
        //     console.log("new",station['station_id']);
        //     console.log("old",station_id);
        //     console.log("bikes",station['num_bikes_available']);
